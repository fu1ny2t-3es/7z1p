...
#define CRYPT_IN(x,a,b,c,d) \
  buf[x] ^= (buf[a] ^ buf[b] ^ buf[c] ^ buf[d]);

  CRYPT_IN(0x00, 0x08, 0x09, 0x0A, 0x0B)
  CRYPT_IN(0x01, 0x09, 0x0A, 0x0B, 0x1C)
  CRYPT_IN(0x02, 0x0A, 0x0B, 0x1C, 0x1D)
  CRYPT_IN(0x03, 0x0B, 0x1C, 0x1D, 0x1E)
  CRYPT_IN(0x04, 0x1C, 0x1D, 0x1E, 0x1F)
  CRYPT_IN(0x05, 0x1D, 0x1E, 0x1F, 0x08)

  CRYPT_IN(0x06, 0x1E, 0x1F, 0x08, 0x09)
  CRYPT_IN(0x07, 0x1F, 0x08, 0x09, 0x0A)

  CRYPT_IN(0x0C, 0x08, 0x0A, 0x1C, 0x1E)
  CRYPT_IN(0x0D, 0x09, 0x0B, 0x1D, 0x1F)
  CRYPT_IN(0x0E, 0x0A, 0x1C, 0x1E, 0x08)
  CRYPT_IN(0x0F, 0x0B, 0x1D, 0x1F, 0x09)
  CRYPT_IN(0x10, 0x1C, 0x1E, 0x08, 0x0A)
  CRYPT_IN(0x11, 0x1D, 0x1F, 0x09, 0x0B)
  CRYPT_IN(0x12, 0x1E, 0x08, 0x0A, 0x1C)
  CRYPT_IN(0x13, 0x1F, 0x09, 0x0B, 0x1D)

  CRYPT_IN(0x14, 0x08, 0x0B, 0x1E, 0x09)
  CRYPT_IN(0x15, 0x09, 0x1C, 0x1F, 0x0A)
  CRYPT_IN(0x16, 0x0A, 0x1D, 0x08, 0x0B)
  CRYPT_IN(0x17, 0x0B, 0x1E, 0x09, 0x1C)
  CRYPT_IN(0x18, 0x1C, 0x1F, 0x0A, 0x1D)
  CRYPT_IN(0x19, 0x1D, 0x08, 0x0B, 0x1E)
  CRYPT_IN(0x1A, 0x1E, 0x09, 0x1C, 0x1F)
  CRYPT_IN(0x1B, 0x1F, 0x0A, 0x1D, 0x08)
